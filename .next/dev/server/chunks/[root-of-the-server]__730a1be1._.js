...
async function GET(request) {
    try {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticateUser"])(request);
        // Récupérer les informations complètes de l'utilisateur
        const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserService"].getUserById(user.id);
        if (!userProfile) {
...
async function PUT(request) {
    try {
        ...
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserService"].updateProfile(user.id, {
            firstName,
            lastName,
            phone,
            address,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__730a1be1._.js.map