...
class UserService {
    ...
    static async register(userData) {
        ...
        if (!userData.avatar) {
            ...
            user.avatar = `https://ui-avatars.com/api/?name=${encodeURIComponent(initials)}&background=FF9A3D&color=fff&size=200&bold=true&rounded=true`;
        }
...
async function POST(request) {
    try {
        ...
        // Appeler le service
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserService"].register({
            firstName,
            lastName,
            email,
            password
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbab932e._.js.map