...
"[project]/Documents/GitHub/PetConnect_PWA/lib/db.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/GitHub/PetConnect_PWA/models/User.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/PetConnect_PWA/node_modules/bcryptjs/index.js [app-ssr] (ecmascript)");
;
;
...
UserSchema.pre("save", async function(next) {
    ...
    try {
        const salt = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].genSalt(10);
        this.password = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].hash(this.password, salt);
        next();
    } catch (error) {
        next(error);
    }
...
UserSchema.methods.comparePassword = async function(candidatePassword) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].compare(candidatePassword, this.password);
};
let User;
try {
...
"[project]/Documents/GitHub/PetConnect_PWA/services/userService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/PetConnect_PWA/lib/db.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/PetConnect_PWA/models/User.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/PetConnect_PWA/node_modules/jsonwebtoken/index.js [app-ssr] (ecmascript)");
...
class UserService {
    ...
    static async register(userData) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].findOne({
            email: userData.email
        });
        if (existingUser) {
            throw new Error("Cet email est déjà utilisé");
        }
        const user = new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](userData);
        await user.save();
        return user;
    }
    // 2. Login (Connexion)
    static async login(email, password) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        }).select("+password");
        if (!user) {
        ...
        const token = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].sign({
            userId: user._id,
            email: user.email,
            role: user.role
        }, JWT_SECRET, {
    ...
    static async updateProfile(userId, updateData) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(userId, updateData, {
            new: true,
            runValidators: true
        });
    }
    ...
    static async changePassword(userId, currentPassword, newPassword) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].findById(userId).select("+password");
        if (!user) {
    ...
    static async deleteProfile(userId) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(userId);
        if (!user) {
            throw new Error("Utilisateur non trouvé");
        }
        return {
    ...
    static async getUserById(userId) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].findById(userId);
    }
    static async getAllUsers() {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$models$2f$User$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            createdAt: -1
        });
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$services$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/PetConnect_PWA/services/userService.ts [app-ssr] (ecmascript)"); // Ajouter cet import
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/PetConnect_PWA/node_modules/next/navigation.js [app-ssr] (ecmascript)"); // Ajouter pour redirection
'use client';
;
;
;
...
const Register = ({ onSwitchToLogin })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$PetConnect_PWA$2f$services$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserService"].register(userData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71984339._.js.map